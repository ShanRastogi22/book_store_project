...
const Navbar = () => {
  ...
  return (
    <>
    <div className={`max-w-screen-2x1 container mx-auto md:px-20 dark:bg-slate-900 dark:text-white px-4 fixed top-0 right-0 left-0 z-50 ${
  ...
  <div className="navbar-start">
    ...
    <a className=" text-2x1 font-bold cursor-pointer">Book_Store</a>
  </div>
